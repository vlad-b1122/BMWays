...
public class SelectorActivity extends AppCompatActivity {
    ...
    {
        this.controlador.obtenerSeries();
    ...
    {
        this.controlador.obtenerCarroceriasPorSerie();
        adaptadorListaCarroceria = new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, controlador.opcionesCarrocerias);
